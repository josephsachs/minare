 ...
 */
class NodeGraphApplication : MinareApplication() {
    private val log = LoggerFactory.getLogger(NodeGraphApplication::class.java)

    @Inject
    lateinit var channelController: NodeGraphChannelController
