...
class DebugLogger @Inject constructor() {
    ...
    private val isEnabled: Map<Type, Boolean> = mapOf(
        ...
        Type.CONNECTION_CONTROLLER_CREATE_CONNECTION to true,
        Type.CONNECTION_CONTROLLER_FOUND_CONNECTION to true,
        Type.CONNECTION_CONTROLLER_STORED_CONNECTION to true,
        Type.CONNECTION_CONTROLLER_UPDATE_CONNECTION to true,
        Type.CONNECTION_CONTROLLER_UPDATE_SOCKETS to true,
        Type.CONNECTION_CONTROLLER_UPSOCKET_DISCONNECT to true,
        Type.CONNECTION_CONTROLLER_CONNECTION_DELETED to false,
        Type.CONNECTION_CONTROLLER_REMOVE_UPSOCKET to true,
        Type.CONNECTION_CONTROLLER_REMOVE_DOWNSOCKET to true,
        Type.CONNECTION_CONTROLLER_UPSOCKET_CLOSED to true,
