...
class DebugLogger {
    ...
    private val isEnabled: Map<DebugType, Boolean> = mapOf(
        ...
        DebugType.UPSOCKET_STARTUP to false,
        DebugType.UPSOCKET_ROUTER_INITIALIZED to false,
        DebugType.UPSOCKET_INITIALIZING_ROUTER to false,
        DebugType.UPSOCKET_SETTING_UP_ROUTE_HANDLER to false,
        DebugType.UPSOCKET_ROUTER_CREATED to false,
        DebugType.UPSOCKET_NEW_WEBSOCKET_CONNECTION to false,
        DebugType.UPSOCKET_WEBSOCKET_CLOSED to false,
        DebugType.UPSOCKET_CONNECTION_TIMEOUT to false,
        DebugType.UPSOCKET_DEPLOYING_HTTP_SERVER to false,
        DebugType.UPSOCKET_HTTP_SERVER_DEPLOYED to false,
        DebugType.UPSOCKET_HTTP_SERVER_STOPPING to false,
        DebugType.UPSOCKET_ENTITY_SYNC_EVENT_ERROR to false,
        DebugType.UPSOCKET_SOCKET_ACCEPTED to false,
        DebugType.UPSOCKET_INITIATE_CONNECTION_ERROR to false,
        DebugType.UPSOCKET_CLOSED_CONNECTION_MISSING_ID to false,
        ...
        DebugType.COORDINATOR_WORKER_FRAME_COMPLETE_EVENT to true,
        DebugType.COORDINATOR_ON_FRAME_COMPLETE_CALLED to true,
        DebugType.COORDINATOR_ON_FRAME_COMPLETE_BLOCKED to true,
        DebugType.COORDINATOR_NEXT_FRAME_EVENT to true,
        DebugType.COORDINATOR_PREPARE_PENDING_MANIFESTS to false,
        DebugType.COORDINATOR_MANIFEST_BUILDER_WROTE_WORKER to true,
        DebugType.COORDINATOR_MANIFEST_BUILDER_WROTE_ALL to true,
        ...
        DebugType.COORDINATOR_OPERATION_HANDLER_HANDLE to true,
        ...
        DebugType.COORDINATOR_OPERATION_HANDLER_ASSIGN_OPERATION to true,
        DebugType.COORDINATOR_OPERATION_HANDLER_ASSIGN_LATE_OPERATION to true,
        DebugType.COORDINATOR_WORK_DISPATCH_DISTRIBUTE_NO_ITEMS to true,
        DebugType.COORDINATOR_WORK_DISPATCH_DISTRIBUTE_NO_WORKERS to true,

        DebugType.COORDINATOR_STARTUP_WAITING_FOR_INFRA_POST to true,
        DebugType.COORDINATOR_STARTUP_INITIAL_WORKER_STATUS to false,
        DebugType.COORDINATOR_STARTUP_HANDLE_WORKER_READY to false,
        DebugType.COORDINATOR_STARTUP_ALL_WORKERS_ALREADY_HERE to false,
        DebugType.COORDINATOR_STARTUP_HANDLE_WORKER_READY to false,
        DebugType.COORDINATOR_STARTUP_ALL_WORKERS_READY to false,
        DebugType.COORDINATOR_SNAPSHOT_COLLECTION_NOT_CREATED to false,
        ...
        DebugType.CONNECTION_CONTROLLER_CREATE_CONNECTION to false,
        DebugType.CONNECTION_CONTROLLER_FOUND_CONNECTION to false,
        DebugType.CONNECTION_CONTROLLER_STORED_CONNECTION to false,
        DebugType.CONNECTION_CONTROLLER_UPDATE_CONNECTION to false,
        DebugType.CONNECTION_CONTROLLER_UPDATE_SOCKETS to false,
        DebugType.CONNECTION_CONTROLLER_UPSOCKET_DISCONNECT to false,
        DebugType.CONNECTION_CONTROLLER_CONNECTION_DELETED to false,
        DebugType.CONNECTION_CONTROLLER_REMOVE_UPSOCKET to false,
        DebugType.CONNECTION_CONTROLLER_REMOVE_DOWNSOCKET to false,
        DebugType.CONNECTION_CONTROLLER_UPSOCKET_CLOSED to false,
        ...
        DebugType.ENTITY_CONTROLLER_SAVE_ENTITY to false,
        DebugType.ENTITY_HYDRATOR_WRITE_FAILED to false,

        DebugType.CONNECTION_TRACKER_REGISTER_CONNECTION to false,
        DebugType.CONNECTION_TRACKER_REMOVE_CONNECTION to false,
